...
# we found in problem 3.2b that the resonant frequencies of this system are near 533.931, 1078.83, and 1612.2 rad/s. We want to essentially repeat the calculation from 3.2b, except we're going to pull out some indices to make graphs of the amplitude surrounding 533.91 rad/s and 1078.83 rad/s.
